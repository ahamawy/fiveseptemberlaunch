...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      'border-b border-surface-border bg-surface-hover/50',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      'border-t border-surface-border bg-surface-hover/50 font-medium',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ...
    className={cn(
      ...
      'hover:bg-surface-hover/50 data-[state=selected]:bg-surface-active',
      className
    )}
    {...props}
  />
