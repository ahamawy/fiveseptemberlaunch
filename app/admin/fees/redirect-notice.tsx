      ...
      <Card className="max-w-2xl bg-glass-dark border-white/10 p-8">
        <div className="text-center space-y-6">
          ...
          <p className="text-gray-400 text-lg">
            We've consolidated all fee management features into a powerful new Formula System.
            All your fee profiles, imports, and calculations are now managed in one place.
          </p>
