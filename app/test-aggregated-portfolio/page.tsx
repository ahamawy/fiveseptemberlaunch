  ...
  return (
    <div className="p-8 bg-background min-h-screen">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Individual vs Aggregated Portfolio Analysis</p>
      </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                <span className="text-muted-foreground">Avg MOIC:</span>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                <span className="text-muted-foreground">Combined Deals:</span>
                <span className="text-white font-semibold">~15</span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Combined Capital:</span>
      ...
      <Card variant="glass" className="mb-8 p-6 border-l-4 border-warning-400">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <p className="text-muted-foreground mb-2">These deals from expected portfolio are not in investor_units:</p>
          ...
          <div>
            <p className="text-muted-foreground mb-2">Additional missing deals:</p>
            <ul className="space-y-1">
      ...
      <Card variant="glass" className="mb-8 p-6">
        ...
        <div className="space-y-3">
          <div className="border-l-4 border-primary-300 pl-4">
            ...
            <p className="text-muted-foreground">30 investors total, Investor 1 has $52,500 of $2,173,225 total</p>
          </div>
          <div className="border-l-4 border-primary-300 pl-4">
            <h4 className="text-white font-semibold">Figure AI Series C</h4>
            <p className="text-muted-foreground">56 investors total, Investor 1 has $238,500 of $4,080,480 total</p>
          </div>
          <div className="border-l-4 border-success-300 pl-4">
            <h4 className="text-white font-semibold">EWT 2</h4>
            <p className="text-muted-foreground text-success-300">Found under Investor 21 (Ahmed Tarek Khalil Ali) - $700,000</p>
          </div>
          <div className="border-l-4 border-warning-300 pl-4">
            <h4 className="text-white font-semibold">OpenAI Partnership</h4>
            <p className="text-muted-foreground">20 investors, Investor 1 has $131,000, Investor 34 (EWT) has $176,492</p>
          </div>
        </div>
      </Card>
