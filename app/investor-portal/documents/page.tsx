...
const mockDocuments: Document[] = [
  { id: '1', name: 'Q3 2024 Quarterly Report', type: 'Report', date: '2024-10-15', size: '2.4 MB', status: 'Available' },
  { id: '2', name: 'K-1 Tax Form 2023', type: 'Tax Form', date: '2024-03-15', size: '156 KB', status: 'Available' },
  { id: '3', name: 'September 2024 Statement', type: 'Statement', date: '2024-10-01', size: '89 KB', status: 'Available' },
  { id: '4', name: 'Limited Partnership Agreement', type: 'Agreement', date: '2024-01-15', size: '3.2 MB', status: 'Available' },
  { id: '5', name: 'Q2 2024 Quarterly Report', type: 'Report', date: '2024-07-15', size: '2.1 MB', status: 'Available' },
  { id: '6', name: 'Capital Call Notice #12', type: 'Other', date: '2024-09-30', size: '45 KB', status: 'Processing' },
];
...
export default function DocumentsPage() {
  ...
  const documentTypes = ['All', 'Report', 'Tax Form', 'Statement', 'Agreement', 'Other'];
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-text-primary">{mockDocuments.length}</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              ...
              <svg className="h-8 w-8 text-accent-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17v1a1 1 0 001 1h4a1 1 0 001-1v-1m3-2V8a2 2 0 00-2-2H8a2 2 0 00-2 2v6m0 4h12a2 2 0 002-2v-3a1 1 0 00-1-1H5a1 1 0 00-1 1v3a2 2 0 002 2z" />
              </svg>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-text-primary">
                  {mockDocuments.filter(d => d.type === 'Tax Form').length}
                </p>
              </div>
              <svg className="h-8 w-8 text-accent-yellow" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-text-primary">
                  {mockDocuments.filter(d => new Date(d.date) >= new Date('2024-10-01')).length}
                </p>
              </div>
