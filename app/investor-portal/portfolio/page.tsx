...
export default function PortfolioPage() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return styles[status as keyof typeof styles] || 'bg-neutral-500/20 text-neutral-400 border-neutral-400/30';
  };
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full">
                    ...
                    <tbody className="divide-y divide-surface-border">
                      {data.deals.map((deal) => (
                        <tr key={deal.dealId} className="hover:bg-surface-hover transition-colors">
                      ...
                      <CardContent>
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-text-primary">{deal.moic.toFixed(2)}x</span>
                          </div>
                        </div>
                        <div className="mt-3">
                          <span className={`px-2 py-1 text-xs font-medium rounded-full border ${getStatusBadge(deal.status)}`}>
